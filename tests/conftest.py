"""pytest configuration for the Planzer test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.planzer`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.planzer import parcels

    parcels._unmapped_statuses_logged.clear()
    parcels._shape_warnings_logged.clear()
    yield
